/* c:/Users/USER/Desktop/BagsAndBeyond/client/src/features/core/components/Footer.jsx */
import { Link } from 'react-router-dom';

export function Footer() {
  return (
    <footer className="bg-[#1C1C1E] dark:bg-[#151515] text-white pt-16 pb-8 border-t border-border/10 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">

          {/* Brand Info */}
          <div className="col-span-1 md:col-span-1 flex flex-col space-y-4">
            <h3 className="font-serif font-bold text-xl">BagsAndBeyond</h3>
            <p className="text-gray-400 text-sm leading-relaxed max-w-xs">
              Elevating Nigerian fashion through curated luxury accessories. Style that moves with you.
            </p>
            <div className="flex space-x-4 pt-2">
              <a
                href="https://instagram.com/bagsandbeyond"
                target="_blank"
              ...
              <a
                href="https://twitter.com/bagsandbeyond"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
              >
              ...
              <a
                href="https://facebook.com/bagsandbeyond"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
              >
          ...
          <div className="flex flex-col space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/shop/bags" className="text-gray-400 hover:text-white text-sm transition-colors">Bags</Link></li>
              <li><Link to="/shop/shoes" className="text-gray-400 hover:text-white text-sm transition-colors">Shoes</Link></li>
            </ul>
          </div>

          {/* Links: Help */}
          <div className="flex flex-col space-y-4">
            <h4 className="font-semibold text-sm tracking-wider uppercase">Help</h4>
            <ul className="space-y-2">
        ...
        <div className="mt-16 pt-8 border-t border-gray-800 flex flex-col items-center justify-center space-y-4 text-center">
          <p className="text-gray-500 text-xs uppercase tracking-widest">
            &copy; 2024 BAGSANDBEYOND. STYLE THAT MOVES WITH YOU.
          </p>
          <Link
            to="/admin/login"
