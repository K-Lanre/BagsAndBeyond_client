/* c:/Users/USER/Desktop/BagsAndBeyond/client/src/features/shop/pages/BagsPage.jsx */
    ...
    <div className="min-h-screen bg-background pb-20 lg:pb-0">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        <nav className="flex items-center gap-2 text-[10px] uppercase tracking-wider">
          ...
          <span className="text-text-muted">/</span>
          <span className="text-primary font-medium">Bags</span>
        </nav>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <p className="text-text-muted text-sm max-w-xl leading-relaxed">
          Discover our exquisite collection of handcrafted bags. From everyday totes to elegant clutches, each piece is designed to complement your style.
        </p>
      </div>
